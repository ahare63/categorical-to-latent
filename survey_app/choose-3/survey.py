...
<<<<<<< HEAD:survey_app/survey.py
data["survey_type"] = "head-to-head"
=======
data["survey_type"] = "choose-3"
>>>>>>> choose_survey:survey_app/choose-3/survey.py
...
print("Each of the five sentences is generated by a different algorithm and presented in a random order (e.g. sentence A may be from algorithm 1 for the first question and from algorithm 2 for the second question.). You will be asked to pick three suggestions you would most like to see if you were using this tool. The results would be presented together, so choose sentences that provide variety.")
print("Press Enter to continue.")
_ = input(">").strip()
print()

print("The sentences that you select should be those you would find most helpful in writing. You can interpret this broadly - your selections don't need to have an obvious or direct connection to the original sentence. If the same sentence is suggested multiple times in the same question, only select it once. Please enter the letter corresponding to each of your selections, separated by commas.")
print("Press Enter to continue.")
_ = input(">").strip()
print()
